  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
            "data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 transition ease-in-out shadow-xl border border-white/20 bg-white/10 backdrop-blur-lg rounded-r-2xl sm:rounded-none sm:border-none",
